...
public class CurveMenuBar extends JMenuBar {
	...
	public CurveMenuBar(final CurveFrame f) {
		...
		aPropos.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				JOptionPane.showMessageDialog(f, "Ce logiciel est propos� par :\n" +
						"Ewans Edouard et\n" +
						"V�drenne Beno�t\n" +
						"\n" +
	...
	private void ouvrirFileChooser() {
		...
		OuvrirFichier jfc = new OuvrirFichier(f, fenetre);
	...
	private void enregistrer(){ //ça ne marche pas
		...
		JFileChooser jfc = new JFileChooser(){
			...
			public void approveSelection() {
				...
				CurveFichierEcriture fichier;
				try {
					fichier = new CurveFichierEcriture(this.getSelectedFile());
					fichier.enregisterFoncVar(f.tracer.fvar);
				} catch (IOException e) {
